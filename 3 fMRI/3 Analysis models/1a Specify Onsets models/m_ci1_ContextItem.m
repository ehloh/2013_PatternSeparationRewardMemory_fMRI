function [ ws, r] = m_ci1_ContextItem( ws, r,  col, memscore4context, memscore4item)
%  [ ws, r] = m1_ContextItem( ws, r,  col, memscore4context, memscore4item)
...
[ws, r ] =i_nointerest(ws, r, col, {'Outcome'; 'Error'; 'Motor'});
