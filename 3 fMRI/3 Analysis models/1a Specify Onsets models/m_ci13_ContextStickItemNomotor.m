function [ ws, r] = m_ci3_ContextItemNomotor( ws, r,  col, memscore4context, memscore4item)
%  [ ws, r] =  m6_ContextItem_nomotor( ws, r,  col, memscore4context, memscore4item)
...
% (1) Construct Context regressors - context 
wss = ws;  wss.c(:, col.c.Context_Duration)=0; % Artificial stick fxns 
[ws, r] = i_context( wss,r , col.c, memscore4context);
