function [ ws, r] = m_ci8_ContextMemcatItempresonly( ws, r,  col, memscore4context, memscore4item)
%  [ ws, r] = m_ci8_ContextMemcatItempresonly( ws, r,  col, memscore4context, memscore4item)
%  Model: Construct regressors for both Context (boxcars) and items
%             Context duration: Entire presentation time (Onset to Offset)
%             Context is split into Similarity x Valence x Mem category (good/bad)
%                   Good memory: >=2 hits
%
...
[ws, r] = i_context_memcat( ws,r , col.c, memscore4context);
