function [ ws, r] = m_ci6_ContextItempmodWithmotor( ws, r,  col, memscore4context, memscore4item)
% [ ws, r] = m_ci4_ContextItempmod( ws, r,  col, memscore4context, memscore4item)
%  Model: Construct regressors for both Context (boxcars) and items (Onsets
%               + memory parametric modulators_
...
%                                   
%  memscore4item:      'ROC', 'Hit', 'Surehit', 'Rem', 'Surerem'
%
...
disp('No point running this model! cm and iom-pmods are too highly correlated!') 
keyboard 
...
[ ws,r ] = i_itempmod_memtype(ws, r, col.i, memscore4item);
