function [ matlabbatch contrastfiles secondlevelfolder] = model_co_m1_2x2(where_brain, secondlevelfolder, subjectlist, analysistype, firstlevelmodel, covariates, memtype,memdata)
% [ matlabbatch contrastfiles secondlevelfolder] = model_co_m1_2x2(where_brain, secondlevelfolder, subjectlist, analysistype, firstlevelmodel, covariates, memtype,memdata)
...
%  % Execute following to use as script:   where_brain=where.data_brain; subjectlist=log.subjects; firstlevelmodel=log.firstlevelmodel; secondlevelmodel=log.secondlevelmodel;  memtype=w.memtype;
...
for s=1:length(subjectlist) 
    ...
    for i=1:length(factorialcells)
        ...
        [ws.contrastnames] = f_findcontrastname(ws.SPM, {factorialcells{i,1}});
