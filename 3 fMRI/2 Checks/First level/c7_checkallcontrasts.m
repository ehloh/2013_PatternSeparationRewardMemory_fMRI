function [ details] = c7_checkallcontrasts(spm, ContextOrItem, memtype)
% [ details] = c7_checkallcontrasts(spm, ContextOrItem, memtype)
% Find contrast weights corresponding to all contrasts
%
