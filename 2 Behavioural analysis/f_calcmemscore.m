function [res] = f_calcmemscore(whichmeasure, responses, farate)
% [res] = f_calcmemscore(whichmeasure, roc_scores, farate)
% Function takes an array of responses (from an OLD cell), and calculates the corresponding
% memory measure. Returns ONE score only. 
% 
% INPUTS
%       - Which measure: 
%               1=     dprime
...
%       - Responses: ROC scores (labelled 1-6)
%             Response types
%                 1=Sure New
%                 2= Unsure New
%                 3= U K 
